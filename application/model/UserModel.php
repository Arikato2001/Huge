...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT user_id, user_name, user_account_type, user_email, user_active, user_has_avatar, user_deleted FROM users";
    ...
    /**
     * Get a human-readable role label for a given account type ID.
     *
     * @param int $type
     * @return string
     */
    public static function getRoleLabel($type)
    {
        switch ($type) {
            case 7:
                return 'Admin';
    ...
    public static function getPublicProfileOfUser($user_id)
    {
        ...
        $sql = "SELECT user_id, user_name, user_account_type, user_email, user_active, user_has_avatar, user_deleted
